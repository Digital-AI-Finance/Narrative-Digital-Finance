...
The review is structured as follows: Section~\ref{sec:methodology} presents the algorithmic framework for systematic literature reviews, including the query design, filtering steps, clustering approach, and quality assessment procedures. Section~\ref{sec:application} applies the methodology to the domain of financial narratives, analyzing research trends, modeling techniques, and conceptual challenges identified in the selected literature. Section~\ref{sec:discussions} discusses the implications of the findings, limitations of existing approaches, and potential directions for future research in financial narrative modeling.
