...
We use the L2 (squared error) cost function:
...
Each speech in our dataset is classified as hawkish, dovish, or neutral using a dictionary-based approach combined with machine learning refinement. The classification follows the methodology of \citet{apel2014foreign}, employing a lexicon of monetary policy-specific terms. Hawkish indicators include references to inflation concerns, tightening, rate increases, and price stability emphasis. Dovish indicators include references to employment concerns, accommodation, growth support, and easing conditions. The classifier assigns each speech to one of three categories based on the relative balance of hawkish and dovish sentiment expressions.
