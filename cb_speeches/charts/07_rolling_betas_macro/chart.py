"""Rolling Betas vs Macro Index - Hawkish and Dovish sentiment betas"""
...
def main():
    ...
    ax.set_title('Rolling Betas: CB Sentiment vs Macro Strength Index (36-month window)')
    ax.legend(loc='best')
    ax.grid(True, alpha=0.3)
    ax.axhline(y=0, color='black', linestyle='-', linewidth=0.5)

    # Add annotation about low predictive power
    ax.text(0.98, 0.02, 'Note: Betas fluctuate around zero\nindicating weak relationship',
